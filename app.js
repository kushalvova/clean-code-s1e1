...
var taskInput=document.querySelector(".section-add__new-task");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.querySelector(".list_incomplete-tasks");//Add a new task.
var completedTasksHolder=document.querySelector(".list_completed-tasks");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    editInput.classList.add("task-input_invisible");
...
var editTask=function(){
    ...
    editInput.classList.toggle("list__task-input-edition");
    label.classList.toggle("list__label_invisible");
};
